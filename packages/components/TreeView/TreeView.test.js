...
const coverage = buildCoverageTree({
  'src/index.js': {
    metrics: {
...
const queryRows = container => [...container.querySelectorAll('tbody > tr > td:first-child')]
  .filter(cell => !cell.parentElement.classList.contains('hidden'))
